package net.swindxg.tutorialmod.item;
...
import net.swindxg.tutorialmod.TutorialMod;
...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> BISMUTH_ITEM_TAB = CREATIVE_MODE_TAB.register("bismuth_item_tab",
